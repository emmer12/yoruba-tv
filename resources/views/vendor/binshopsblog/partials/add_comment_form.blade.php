<div class='add_comment_area'>
    <h5 class='font-semibold my-2'>Add a comment</h5>
    <form method='post'
        ...
        <div class="form-group ">
            ...
            <textarea class="form-control" name='comment' required id="comment" placeholder="Write your comment here" rows="7">{{ old('comment') }}</textarea>
                    ...
                    <div class='col-6'>
                        <div class="form-group">
                            ...
                            <input type='url' class="form-control" name='author_website' id="author_website"
                                placeholder="Your Website URL" value="{{ old('author_website') }}">
                        </div>
                    </div>
                @endif --}}
            </div>
        ...
        <div class="my-3">
            <button type='submit' class="btn btn-primary w-full bg-primary">Add Comment</button>
        </div>
