<x-layout>
    <div>
        <x-banner title="Contact us" subtitle="Get in touch" />
    </div>
                ...
                <div class="card sm:w-1/2 w-full bg-gray-50 rounded-xl p-4">
                    ...
                    <ul class="my-3 flex flex-col gap-3">
                        <li class="elementor-icon-list-item">
                            <a class="flex gap-2" href="https://goo.gl/maps/XyANinc4EoxHZguc9">
                                ...
                                <span class="elementor-icon-list-text">202 Helga Springs Rd, Crawford, TN 38554</span>
                            </a>
                        </li>
                        <li class="elementor-icon-list-item">
                            <a href="tel:800.275.8777" class="flex gap-2">
                                ...
                                <span class="elementor-icon-list-text">800.275.8777</span>
                            </a>
                        </li>
                        <li class="elementor-icon-list-item">
                            <a class="flex gap-2" href="https://telegram.me/telegram">
